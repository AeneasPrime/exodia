...
// V5: Dark Warm Editorial — V2's editorial structure in a warm dark palette.
...
export default function V5() {
  ...
  return (
    <div data-page="v5" style={{ background: T.bg, color: T.fg, minHeight: "100vh", fontFamily: '"Berkeley Mono", ui-monospace, monospace', opacity: fading ? 0 : 1, transition: "opacity 0.4s ease" }}>
      <style>{`
        [data-page="v5"] ::selection { background: ${T.accent}; color: ${T.bg}; }
        @keyframes orb-drift {
      ...
      >
        <div className="max-w-6xl mx-auto px-6 sm:px-10 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <button
              onClick={() => { setFading(true); setTimeout(() => router.push("/v6"), 400); }}
        ...
        <div className="max-w-6xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-8">
              ...
              <p className="text-base leading-relaxed mb-8 opacity-0 animate-fade-in-up delay-2" style={{ color: "#B5B0A8", maxWidth: 440 }}>
      ...
      <section id="platform" className="py-24 sm:py-32 px-6 sm:px-10">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <iframe
              key={activeDemo}
              src={activeDemo === "clerk" ? "/v5/demo?embed=1" : activeDemo === "citizen" ? "/v5/demo/citizen?embed=1" : "/v5/demo/finance?embed=1"}
